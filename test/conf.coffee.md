    ...
    it 'The FreeSwitch configuration', ->
      ...
      expected_config = '''
        ...
        <macros>
        <language name="en" sound-path="/opt/freeswitch/share/freeswitch/sounds/en/us/callie">
        ...
        <input pattern="^[:]$" break_on_match="true">
        <match>
        <action function="play-file" data="phonetic-ascii/58.wav"/>
        </match>
        </input>
        <input pattern="^[ ]$" break_on_match="true">
        <match>
        ...
        <input pattern="^([0-9]+)\\.0([01])$" break_on_match="true">
        <match>
        ...
        <input pattern="^([0-9]+)\\.0([2-9])$" break_on_match="true">
        <match>
        <action function="phrase" data="$1" phrase="say-currency"/>
        <action function="phrase" data="$2" phrase="say-number"/>
        <action function="play-file" data="currency/cents.wav"/>
        </match>
        </input>
        ...
        <match>
        <action function="phrase" data="$1 million counted $2" phrase="say-number"/>
        </match>
        </input>
        <input pattern="^1000$" break_on_match="true">
        <match>
        <action function="phrase" data="counted thousand" phrase="say-number"/>
        </match>
        </input>
        <input pattern="^([2-9]|[1-9][0-9]|[1-9][0-9][0-9])000$" break_on_match="true">
        <match>
        ...
        <match>
        <action function="phrase" data="thousand counted $1" phrase="say-number"/>
        </match>
        </input>
        <input pattern="^([2-9]|[1-9][0-9]|[1-9][0-9][0-9])([0-9]{3})$" break_on_match="true">
        <match>
        <action function="phrase" data="$1 thousand counted $2" phrase="say-number"/>
        </match>
        </input>
        <input pattern="^100$" break_on_match="true">
        <match>
        <action function="phrase" data="counted hundred" phrase="say-number"/>
        </match>
        </input>
        <input pattern="^([2-9])00$" break_on_match="true">
        <match>
        ...
        <match>
        <action function="phrase" data="hundred counted $1" phrase="say-number"/>
        </match>
        </input>
        <input pattern="^([2-9])([0-9][0-9])$" break_on_match="true">
        <match>
        <action function="phrase" data="$1 hundred counted $2" phrase="say-number"/>
        </match>
        </input>
        <input pattern="^([1-3]0|1[0-9]|[1-9])$" break_on_match="true">
        <match>
        <action function="play-file" data="digits/h-$1.wav"/>
        </match>
        </input>
        <input pattern="^([2-9])([1-9])" break_on_match="true">
        <match>
        ...
        <input pattern="^([2-9])([1-9])f?$" break_on_match="true">
        <match>
        <action function="phrase" data="$1_0" phrase="say-number"/>
        ...
        <language name="en-US" sound-path="/opt/freeswitch/share/freeswitch/sounds/en/us/callie">
        <macro name="say-single">
        <input pattern="^([0-9])$" break_on_match="true">
        <match>
        <action function="play-file" data="digits/$1.wav"/>
